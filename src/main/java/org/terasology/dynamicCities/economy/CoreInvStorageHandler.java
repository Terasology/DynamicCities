 ...
 */
public class CoreInvStorageHandler implements StorageComponentHandler<InventoryComponent> {

    @Override
    public int store(InventoryComponent inventoryComponent, String resource, int amount) {
